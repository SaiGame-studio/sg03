...
| `ERR_ABILITY_SKELETON_SHIELD_NO_RIA` | `skeleton_shield requires untriggered ria in front_line` | Skeleton Shield requires Ria on the front line. | Khiên Xương yêu cầu Ria ở hàng trước. | `lib_ability_darkborn.lua` |
