...
| `ERR_ABILITY_HOLY_GLOW_NO_ELF` | `holy_glow requires an untriggered light_elf character in front_line` | Holy Glow requires an active Light Elf on the front line. | Hào Quang Thánh Linh yêu cầu Tinh Linh ở hàng trước. | `lib_ability_all.lua` |
