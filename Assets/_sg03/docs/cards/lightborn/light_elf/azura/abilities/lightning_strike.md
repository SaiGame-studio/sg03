...
## Mô Tả Kỹ Năng
Lightning Strike chỉ có thể được triển khai bởi Azura. Cô dồn linh lực sấm sét vào quyền thuật rồi đánh vào Character đối thủ được chọn; nếu có một Character liền kề trên cùng battle line, đòn đánh lan sang mục tiêu đó. Mỗi mục tiêu trúng đòn nhận sát thương bằng `base_stats.atk` của Lightning Strike.
...
- Chọn một Character đối thủ. Nếu có Character khác đứng liền kề trên cùng battle line, kỹ năng tấn công cả hai; nếu không, kỹ năng chỉ tấn công mục tiêu đã chọn.
