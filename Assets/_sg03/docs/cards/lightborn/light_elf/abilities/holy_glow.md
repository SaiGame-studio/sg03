...
- **Thẻ Nhân Vật Yêu Cầu**: [Zelena](../common/zelena.md)
...
- **Điều Kiện**: Yêu cầu 1 thẻ nhân vật [Zelena](../common/zelena.md) chưa kích hoạt trên `own_frontline`.

### Các Bước Thực Thi
1. Tìm [Zelena](../common/zelena.md) chưa kích hoạt trên `own_frontline`.
