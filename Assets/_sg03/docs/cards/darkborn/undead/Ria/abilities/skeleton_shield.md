...
- **Điều Kiện**: Yêu cầu 1 thẻ [Ria](../ria.md) chưa kích hoạt trên `own_frontline` VÀ 1 thẻ [Skeleton](../skeleton.md) khác trên `own_frontline`. Thẻ mục tiêu phải đang bị đối phương chọn làm mục tiêu tấn công.

### Các Bước Thực Thi
1. Tìm `ria` chưa kích hoạt và 1 `skeleton` chưa kích hoạt (khác mục tiêu).
