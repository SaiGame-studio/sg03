...
- Đồng minh thường gặp: các cộng đồng Lightborn chia sẻ tri thức và năng lực bảo hộ; những nhóm Darkborn duy trì quan hệ thương mại, phòng thủ và cùng tồn tại.
- Kẻ thù thường gặp: **Natureborn**, do xung đột về lãnh thổ, tài nguyên và sự mở rộng công nghệ; các phe phái khác đe dọa khu dân cư hoặc tuyến giao thương của Humans.
...
Tên chủng tộc chính thức trong nội dung và tài liệu luôn dùng tiếng Anh: **Darkborn**, **Lightborn**, **Natureborn**, **Humans**. Chủng tộc mô tả nguồn gốc, văn hóa hoặc bản chất sức mạnh, không quyết định một Character là thiện hay ác. Quan hệ đồng minh và kẻ thù áp dụng cho từng cộng đồng, tổ chức hoặc hoàn cảnh lịch sử, không phải quy luật tuyệt đối giữa toàn bộ các chủng tộc. Các định danh kỹ thuật cũ được giữ nguyên cho đến khi dữ liệu và script được migrate; chúng không tạo thêm chủng tộc chính.
