...
├── 03_characters.md              # Danh mục Thẻ bài (Nhân vật & Kỹ năng)
...
3. **[Danh Mục Thẻ Bài & Thông Số](03_characters.md)** — Danh mục đầy đủ các thẻ nhân vật (`azure_blade`, `goblin_shaman`, `light_elf`, `hellscythe`, `skeleton`) và thẻ kỹ năng phân theo chủng tộc.
